...
% =================================================================
\usepackage{fontspec}    % UTF-8 encoding for source file
\setmainfont{Palatino Linotype}           % Palatino font for a professional look
...
\title{Shocks and income inequality\thanks{Corresponding author: Oleg Gurshev. Email: o.gurshev@grape.org.pl.\\Financial support from the Polish National Science Center (grant no. 2021/43/B/HS4/03241) is gratefully acknowledged.}}% grant statement
\author{
    Oleg Gurshev  \\ 
