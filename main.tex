...
\usepackage{lmodern}
\linespread{1.5}                % Increased line spacing
...
% Oleg: changed wording to provide a nice link to why do we need these shocks in the first place
...
% - Extra motivation in the methodology paragraph
% - Improved framing of the article in the contribution paragraph
...
% - Added VAR algebra and extra explanations
% - Revised Table 1 to include Kelley and Std
% - Added a spli into 3 subsections and improved wording for precision (all three subsections)
...
% shocks
\subsection{Shocks} 
% \footnote{See characterization of popular identification strategies in \textcite{ramey2016macroeconomic}.}
% \footnote{This seminal paper has been revisited by \textcite{Binet2015, Herwartz2018, Keating2013}.}
